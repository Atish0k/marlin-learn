<?php
    $users = [
        [
            'ava_image_url' => 'img/demo/avatars/avatar-b.png',
            'span_status' => 'status-warning',
            'username' => 'Oliver Kopyov',
            'filter_tags' => 'oliver kopyov',
            ...
            'twitter_href_color' => '#38A1F3',
            'linkedin_href_color' => '#0077B5',
            'facebook_class' => 'fa-facebook-square',
            'twitter_class' => 'fa-twitter-square',
            'linkedin_class' => 'fa-linkedin',

        ],
        [
            'ava_image_url' => 'img/demo/avatars/avatar-c.png',
            'span_status' => 'status-success',
            'username' => 'Sesha Gray',
            'filter_tags' => 'sesha gray',
        ...
        [
            'ava_image_url' => 'img/demo/avatars/avatar-e.png',
            'span_status' => 'status-warning',
            'username' => 'Dr. John Cook PhD',
            'filter_tags' => 'dr john cook',
            'role' => '',
            'phone_number' => '+1 313-779-1347',
        ...
        [
            'ava_image_url' => 'img/demo/avatars/avatar-k.png',
            'span_status' => 'status-success',
            'username' => 'Jim Ketty',
            'filter_tags' => 'jim ketty',
            'role' => 'Staff Orgnizer, Gotbootstrap Inc.',
            'phone_number' => '+1 313-779-3314',
        ...
        [
            'ava_image_url' => 'img/demo/avatars/avatar-h.png',
            'span_status' => 'status-success',
            'username' => 'Sarah McBrook',
            'filter_tags' => 'sarah mcbrook',
            'role' => 'Xray Division, Gotbootstrap Inc.',
            'phone_number' => '+1 313-779-7613',
        ...
        [
            'ava_image_url' => 'img/demo/avatars/avatar-i.png',
            'span_status' => 'status-success',
            'username' => 'Jimmy Fellan',
            'filter_tags' => 'jimmy fellan',
            'role' => 'Accounting, Gotbootstrap Inc.',
            'phone_number' => '+1 313-779-4314',
            'email' => 'jimmy.fallan@smartadminwebapp.com',
            'address' => '55 Smyth Rd, Detroit, MI, 48341, USA',
        ...
        [
            'ava_image_url' => 'img/demo/avatars/avatar-j.png',
            'span_status' => 'status-success',
            'username' => 'Arica Grace',
            'filter_tags' => 'arica grace',
            'role' => 'Accounting, Gotbootstrap Inc.',
            'phone_number' => '+1 313-779-3347',
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['filter_tags']?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status <?php echo $user['span_status']?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $user['ava_image_url']?>'); background-size: cover;"></span>
                                </span>
